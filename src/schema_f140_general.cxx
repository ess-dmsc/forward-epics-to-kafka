...
F_t Field(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVField const * field, int level);

inline static F_t field_PVStructure(flatbuffers::FlatBufferBuilder & builder, PVStructure const * field, int level) {
...
inline static F_t field_PVStructure_array(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVValueArray<epics::pvData::PVStructurePtr> const * field, int level) {
...
inline static F_t field_PVScalar(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVScalar const * field, int level) {
	FLOG(level, "scalar");
...
inline static F_t field_PVScalar_array(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVScalarArray const * field, int level) {
...
inline static F_t field_PVUnion(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVUnion const * field, int level) {
	FLOG(level, "union");
	auto f3 = field->get();
	if (f3) {

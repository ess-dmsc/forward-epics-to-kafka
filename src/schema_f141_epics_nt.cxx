...
typedef struct { PV type; flatbuffers::Offset<void> off; } PV_t;
...
template <typename T0> struct BuilderType_to_Enum_PV : public Enum_PV_Base { static PV v(); };
template <> struct BuilderType_to_Enum_PV<NTScalarByteBuilder>        : public Enum_PV_Base { static PV v() { return PV::NTScalarByte; } };
template <> struct BuilderType_to_Enum_PV<NTScalarUByteBuilder>       : public Enum_PV_Base { static PV v() { return PV::NTScalarUByte; } };
template <> struct BuilderType_to_Enum_PV<NTScalarShortBuilder>       : public Enum_PV_Base { static PV v() { return PV::NTScalarShort; } };
template <> struct BuilderType_to_Enum_PV<NTScalarUShortBuilder>      : public Enum_PV_Base { static PV v() { return PV::NTScalarUShort; } };
template <> struct BuilderType_to_Enum_PV<NTScalarIntBuilder>         : public Enum_PV_Base { static PV v() { return PV::NTScalarInt; } };
template <> struct BuilderType_to_Enum_PV<NTScalarUIntBuilder>        : public Enum_PV_Base { static PV v() { return PV::NTScalarUInt; } };
template <> struct BuilderType_to_Enum_PV<NTScalarLongBuilder>        : public Enum_PV_Base { static PV v() { return PV::NTScalarLong; } };
template <> struct BuilderType_to_Enum_PV<NTScalarULongBuilder>       : public Enum_PV_Base { static PV v() { return PV::NTScalarULong; } };
template <> struct BuilderType_to_Enum_PV<NTScalarFloatBuilder>       : public Enum_PV_Base { static PV v() { return PV::NTScalarFloat; } };
template <> struct BuilderType_to_Enum_PV<NTScalarDoubleBuilder>      : public Enum_PV_Base { static PV v() { return PV::NTScalarDouble; } };

template <> struct BuilderType_to_Enum_PV<NTScalarArrayByteBuilder>   : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayByte; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayUByteBuilder>  : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayUByte; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayShortBuilder>  : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayShort; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayUShortBuilder> : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayUShort; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayIntBuilder>    : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayInt; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayUIntBuilder>   : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayUInt; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayLongBuilder>   : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayLong; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayULongBuilder>  : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayULong; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayFloatBuilder>  : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayFloat; } };
template <> struct BuilderType_to_Enum_PV<NTScalarArrayDoubleBuilder> : public Enum_PV_Base { static PV v() { return PV::NTScalarArrayDouble; } };
...
PV_t make_PV_scalar(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVScalar * field) {
...
PV_t make_PV_scalar_array(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVScalarArray * field) {
	using S = epics::pvData::ScalarType;
	using namespace epics::pvData;
	using namespace PVStructureToFlatBufferN;
...
PV_t make_PV(flatbuffers::FlatBufferBuilder & builder, epics::pvData::PVFieldPtr const & field) {
	...
	switch (t1) {
	case T::scalar:
		return make_PV_scalar(builder, static_cast< epics::pvData::PVScalar*>(field.get()));
	case T::scalarArray:
...
BrightnESS::FlatBufs::FB_uptr convert(EpicsPVUpdate const & up) override {
	...
	auto n = builder->CreateString(up.pvstr->getStructure()->getID());
	auto vF = make_PV(*builder, up.pvstr);
